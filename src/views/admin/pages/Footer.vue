  ...
  <q-page class="q-pa-sm">
    <q-card class="no-shadow" bordered>
      <q-card-section class="row q-pa-lg">
        ...
        <q-space></q-space>
        <q-btn icon="github" flat dense color="grey-8"></q-btn>
        <q-btn icon="facebook" flat dense color="grey-8"></q-btn>
        <q-btn icon="twitter" flat dense color="grey-8"></q-btn>
        <q-btn icon="instagram" flat dense color="grey-8"></q-btn>
      </q-card-section>
    </q-card>
    ...
    <q-card class="q-mt-md row no-shadow" bordered>
      <q-card-section class="col-12 text-center q-pa-lg">
        <q-btn icon="format_quote" class="q-mx-sm" flat dense color="grey-8"></q-btn>
        <q-btn icon="facebook" class="q-mx-sm" flat dense color="grey-8"></q-btn>
        <q-btn icon="instagram" class="q-mx-sm" flat dense color="grey-8"></q-btn>
        <q-btn icon="instagram" class="q-mx-sm" flat dense color="grey-8"></q-btn>
        <br/>
